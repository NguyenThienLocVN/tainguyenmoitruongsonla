...
export default class QuanLyCapPhep extends React.Component {
    ...
    render(){
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP TÀI NGUYÊN NƯỚC" previousLink="/tai-nguyen-nuoc" showHeadImage={true} layout48={true} />
                            ...
                            <div className="col-lg-12 p-0">
                                <ul className="nav flex-column nav-pills pl-2 pb-1 mx-auto my-3 rounded">
                                    ...
                                    <div className="exploit-surfacewater">
                                        ...
                                        <li className="nav-item">
                                            <Link to="/tai-nguyen-nuoc/cap-phep/nuoc-duoi-dat/khai-thac" className="nav-link font-13 hover-link">Khai Thác</Link>
                                        </li>
                                        <li className="nav-item">
